...
export default function Home() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto', fontFamily: 'Arial, sans-serif' }}>
      {/* Aplicar estilos globales de forma simple en React/Next.js */}
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '15px', padding: '20px', border: '1px solid #0070f3', borderRadius: '8px', backgroundColor: '#f9f9f9' }}>
        ...
        {/* Selector de País (gl) - Usando la lista ordenada */}
      ...
      {results.length > 0 && (
        <div style={{ marginTop: '30px' }}>
          ...
          <button 
            onClick={() => exportToCSV(results, `sugerencias_${keyword.replace(/\s/g, '_')}.csv`)}
